...
def setup_routes(app):
    ...
    app.router.add_route('GET', '/rest/block/transactions/list/{block_pointer}', get_block_transactions_list)
    ...
    if app["merkle_proof"]:
        ...
        app.router.add_route('GET', '/rest/transaction/merkle_proof/{tx_pointer}', calculate_transaction_merkle_proof)

    app.router.add_route('GET', '/rest/transaction/calculate/merkle_proof/{tx_pointer}', calculate_transaction_merkle_proof)
