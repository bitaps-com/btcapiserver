...
class TransactionsAPIEndpointsTest(unittest.TestCase):
    ...
    def test_get_transaction(self):
        ...
        r = requests.get(base_url + "/rest/transaction/f7a0f2b9dfa73dc795ca42fc4104adaa0f8c8a268dbb9348c987ff037fcc73ae")
        self.assertEqual(r.status_code, 200)
        d = r.json()["data"]
        pprint(d)
        ...
        if option_merkle_proof:
            ...
            self.assertEqual(merkle_root_from_proof(d["merkleProof"], d['txId'], d["blockIndex"]), m_root)
